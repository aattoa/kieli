...
namespace {
    ...
    constexpr auto keywords = std::to_array<std::string_view>({
        ...
        "as",     "enum",   "struct",   "concept", "impl",  "alias", "import",  "export",
        "module", "sizeof", "typeof",   "unsafe",  "mov",   "meta",  "where",   "dyn",
        "macro",  "global", "defer",    "String",  "Float", "Char",  "Bool",    "I8",
        "I16",    "I32",    "I64",      "U8",      "U16",   "U32",   "U64",     "Self",
    });
} // namespace
