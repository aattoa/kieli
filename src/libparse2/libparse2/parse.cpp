...
auto libparse2::parse_mutability(Context& context) -> std::optional<cst::Mutability>
{
...
auto libparse2::parse_class_reference(Context& context) -> std::optional<cst::Class_reference>
{
    // TODO: cleanup
...
auto libparse2::parse_type_annotation(Context& context) -> std::optional<cst::Type_annotation>
{
...
auto libparse2::extract_qualified_name(Context& context, std::optional<cst::Root_qualifier>&& root)
    -> cst::Qualified_name
{
...
auto libparse2::extract_class_references(Context& context)
