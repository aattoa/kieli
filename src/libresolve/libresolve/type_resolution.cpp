    ...
    struct Type_resolution_visitor {
        ...
        auto operator()(ast::type::Self&) -> hir::Type
        {
            ...
            context.error(
                ...
                { "The Self type is only accessible within classes, 'impl' blocks, or 'inst' "
                  "blocks" });
        }
        ...
        auto operator()(ast::type::Typeof& typeof_) -> hir::Type
        {
            ...
            return context.resolve_expression(*typeof_.inspected_expression, child_scope, space)
                .type.with(this_type.source_view);
        }
        ...
        auto operator()(ast::type::Typename& type) -> hir::Type
        {
            ...
            return utl::match(
                ...
                [this](utl::Wrapper<Struct_template_info> const info) -> hir::Type {
                    return hir::Type {
                        context.wrap_type(hir::type::Structure {
                            .info = context.instantiate_struct_template_with_synthetic_arguments(
                                info, this_type.source_view),
                            .is_application = true,
                        }),
                        this_type.source_view,
                    };
                ...
                [this](utl::Wrapper<Enum_template_info> const info) -> hir::Type {
                    return hir::Type {
                        context.wrap_type(hir::type::Enumeration {
                            .info = context.instantiate_enum_template_with_synthetic_arguments(
                                info, this_type.source_view),
                            .is_application = true,
                        }),
                        this_type.source_view,
                ...
                [&](utl::Wrapper<Alias_template_info> const info) -> hir::Type {
                    return context
                        .resolve_alias(context.instantiate_alias_template_with_synthetic_arguments(
                            info, this_type.source_view))
                        .aliased_type.with(this_type.source_view);
                },

                [](utl::Wrapper<Typeclass_info>) -> hir::Type { utl::todo(); },
                [](utl::Wrapper<Typeclass_template_info>) -> hir::Type { utl::todo(); });
        }
        ...
        auto operator()(ast::type::Template_application& application) -> hir::Type
        {
            return utl::match(
                ...
                [&](utl::Wrapper<Alias_template_info> info) -> hir::Type {
                    return context
                        .resolve_alias(context.instantiate_alias_template(
                            info, application.arguments, this_type.source_view, scope, space))
                        .aliased_type.with(this_type.source_view);
                },
                [this](utl::Wrapper<Typeclass_template_info>) -> hir::Type {
                    context.error(
                        this_type.source_view, { "Expected a type, but found a typeclass" });
                },

                [this](utl::wrapper auto) -> hir::Type {
                    context.error(
                        this_type.source_view,
                        { "Template argument list applied to a non-template entity" });
                });
        }
