...
libresolve::Resolution_constants::Resolution_constants(hir::Node_arena& arena)
    : immut { arena.wrap<hir::Mutability::Variant>(
...
auto libresolve::Context::error(
    utl::Source_view const source_view, utl::diagnostics::Message_arguments const& arguments)
    -> void
{
...
auto libresolve::Context::fresh_unification_mutability_variable(utl::Source_view const source_view)
    -> hir::Mutability
{
...
auto libresolve::Context::fresh_unification_type_variable_state(
    hir::Unification_type_variable_kind const variable_kind)
    -> utl::Wrapper<hir::Unification_type_variable_state>
{
    return node_arena.wrap(
        hir::Unification_type_variable_state { hir::Unification_type_variable_state::Unsolved {
            .tag  = hir::Unification_variable_tag { current_unification_variable_tag++.get() },
            .kind = variable_kind,
        } });
}

auto libresolve::Context::fresh_general_unification_type_variable(
...
auto libresolve::Context::fresh_integral_unification_type_variable(
    utl::Source_view const source_view) -> hir::Type
{
    return hir::Type {
        wrap_type(hir::type::Unification_variable {
...
auto libresolve::Context::immut_constant(utl::Source_view const view) -> hir::Mutability
{
    return hir::Mutability { constants.immut, view };
}

auto libresolve::Context::mut_constant(utl::Source_view const view) -> hir::Mutability
{
    return hir::Mutability { constants.mut, view };
}

auto libresolve::Context::unit_type(utl::Source_view const view) -> hir::Type
{
    return hir::Type { constants.unit_type, view };
}

auto libresolve::Context::i8_type(utl::Source_view const view) -> hir::Type
{
    return hir::Type { constants.i8_type, view };
}

auto libresolve::Context::i16_type(utl::Source_view const view) -> hir::Type
{
    return hir::Type { constants.i16_type, view };
}

auto libresolve::Context::i32_type(utl::Source_view const view) -> hir::Type
{
    return hir::Type { constants.i32_type, view };
}

auto libresolve::Context::i64_type(utl::Source_view const view) -> hir::Type
{
    return hir::Type { constants.i64_type, view };
}

auto libresolve::Context::u8_type(utl::Source_view const view) -> hir::Type
{
    return hir::Type { constants.u8_type, view };
}

auto libresolve::Context::u16_type(utl::Source_view const view) -> hir::Type
{
    return hir::Type { constants.u16_type, view };
}

auto libresolve::Context::u32_type(utl::Source_view const view) -> hir::Type
{
    return hir::Type { constants.u32_type, view };
}

auto libresolve::Context::u64_type(utl::Source_view const view) -> hir::Type
{
    return hir::Type { constants.u64_type, view };
}

auto libresolve::Context::floating_type(utl::Source_view const view) -> hir::Type
{
    return hir::Type { constants.floating_type, view };
}

auto libresolve::Context::boolean_type(utl::Source_view const view) -> hir::Type
{
    return hir::Type { constants.boolean_type, view };
}

auto libresolve::Context::character_type(utl::Source_view const view) -> hir::Type
{
    return hir::Type { constants.character_type, view };
}

auto libresolve::Context::string_type(utl::Source_view const view) -> hir::Type
{
    return hir::Type { constants.string_type, view };
}

auto libresolve::Context::self_placeholder_type(utl::Source_view const view) -> hir::Type
{
    return hir::Type { constants.self_placeholder_type, view };
}

auto libresolve::Context::size_type(utl::Source_view const view) -> hir::Type
{
...
auto libresolve::Context::associated_namespace(hir::Type type) -> utl::Wrapper<Namespace>
{
    ...
    error(
        type.source_view(),
        { std::format("{} does not have an associated namespace", hir::to_string(type)) });
}
    ...
    -> hir::Mutability
{
    return utl::match(
        ...
        [&](ast::Mutability::Concrete const concrete) {
            return concrete.is_mutable.get() ? mut_constant(mutability.source_view)
                                             : immut_constant(mutability.source_view);
        },
        [&](ast::Mutability::Parameterized const parameterized) {
            if (auto* const mutability_binding
            ...
            error(
                ...
                { "No mutability parameter '{}: mut' in scope"_format(parameterized.name) });
        });
}

auto libresolve::Context::resolve_class_reference(
    ast::Class_reference& reference, Scope& scope, Namespace& space) -> hir::Class_reference
{
    return utl::match(
...
auto libresolve::Context::resolve_template_parameters(
    std::span<ast::Template_parameter> const ast_parameters, Namespace& space)
    ...
    for (ast::Template_parameter& parameter : ast_parameters) {
        ...
        auto const add_parameter = [&](hir::Template_parameter::Variant&& value) {
            auto const make_default_argument = [&](ast::Template_argument&& default_argument) {
                ...
                utl::match(
                    default_argument.value,
                    [&](utl::Wrapper<ast::Type> const type_argument) {
                        (void)resolve_type(*type_argument, parameter_scope, space);
                    },
                    [&](utl::Wrapper<ast::Expression> const value_argument) {
                        (void)resolve_expression(*value_argument, parameter_scope, space);
                    },
                    [&](ast::Mutability const mutability_argument) {
                        (void)resolve_mutability(mutability_argument, parameter_scope);
                    },
            ...
            parameters.push_back(hir::Template_parameter {
                ...
                .default_argument
                = std::move(parameter.default_argument).transform(make_default_argument),
        ...
        utl::match(
            ...
            [](ast::Template_parameter::Value_parameter&) { utl::todo(); });
    }
...
{
    return utl::match(
        value, [](auto const& enumeration) { return enumeration.constructors.size(); });
}
