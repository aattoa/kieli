...
TEST("liblex::apply_scientific_exponent") {
    ...
    REQUIRE(liblex::apply_scientific_exponent(max_usize, 1) ==
...
TEST("liblex::parse_integer") {
    ...
    REQUIRE(liblex::parse_integer("3", 2) ==
            tl::unexpected { liblex::Numeric_error::invalid_argument });
    REQUIRE(liblex::parse_integer("9999999999999999999999999999") ==
            tl::unexpected { liblex::Numeric_error::out_of_range });
    REQUIRE(liblex::parse_integer("5w") ==
            tl::unexpected { liblex::Numeric_error::invalid_argument });
    REQUIRE(liblex::parse_integer("w5") ==
            tl::unexpected { liblex::Numeric_error::invalid_argument });
}
...
TEST("liblex::parse_floating") {
    ...
    REQUIRE(liblex::parse_floating("3.14e9999999999999999999999999999") ==
            tl::unexpected { liblex::Numeric_error::out_of_range });
}
