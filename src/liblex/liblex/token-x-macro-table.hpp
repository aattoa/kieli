...
KIELI_X_TOKEN_DO(If,                   "if",         "a keyword")
KIELI_X_TOKEN_DO(Else,                 "else",       "a keyword")
KIELI_X_TOKEN_DO(For,                  "for",        "a keyword")
KIELI_X_TOKEN_DO(In,                   "in",         "a keyword")
KIELI_X_TOKEN_DO(While,                "while",      "a keyword")
KIELI_X_TOKEN_DO(Loop,                 "loop",       "a keyword")
KIELI_X_TOKEN_DO(Continue,             "continue",   "a keyword")
KIELI_X_TOKEN_DO(Break,                "break",      "a keyword")
KIELI_X_TOKEN_DO(Match,                "match",      "a keyword")
KIELI_X_TOKEN_DO(Ret,                  "ret",        "a keyword")
KIELI_X_TOKEN_DO(Fn,                   "fn",         "a keyword")
KIELI_X_TOKEN_DO(Enum,                 "enum",       "a keyword")
KIELI_X_TOKEN_DO(Struct,               "struct",     "a keyword")
KIELI_X_TOKEN_DO(Concept,              "concept",    "a keyword")
KIELI_X_TOKEN_DO(Impl,                 "impl",       "a keyword")
KIELI_X_TOKEN_DO(Alias,                "alias",      "a keyword")
KIELI_X_TOKEN_DO(Import,               "import",     "a keyword")
KIELI_X_TOKEN_DO(Export,               "export",     "a keyword")
KIELI_X_TOKEN_DO(Module,               "module",     "a keyword")
KIELI_X_TOKEN_DO(Sizeof,               "sizeof",     "a keyword")
KIELI_X_TOKEN_DO(Typeof,               "typeof",     "a keyword")
