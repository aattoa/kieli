...
namespace {
    template <class T> constexpr auto min = std::numeric_limits<T>::min();
    template <class T> constexpr auto max = std::numeric_limits<T>::max();
    template <class T> constexpr auto safe_min = utl::Safe_integer<T> { min<T> };
    template <class T> constexpr auto safe_max = utl::Safe_integer<T> { max<T> };
}
